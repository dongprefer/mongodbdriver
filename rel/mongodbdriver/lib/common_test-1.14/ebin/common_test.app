...
{application,common_test,
             [{description,"The OTP Common Test application"},
              ...
              {modules,[ct,ct_config,ct_config_plain,ct_config_xml,
                        ...
                        ct_webtool,ct_webtool_sup,cth_conn_log,
                        cth_log_redirect,cth_surefire,erl2html2,test_server,
                        test_server_ctrl,test_server_gl,test_server_io,
                        test_server_node,test_server_sup,unix_telnet,vts]},
